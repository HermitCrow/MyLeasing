...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Emmanuel", "Ulloa", "emmanululloa@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Emmanuel", "Ulloa", "master1932@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("2020", "Emmanuel", "Ulloa", "emmanululloa@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
